...
$$
Note that for this definition, $i$ and $j$ need not be exclusive.  Another definition of the average outdegree is: $\langle\texttt{degree}(X)\rangle = \texttt{mean}(\texttt{rowSums}(X))$.
